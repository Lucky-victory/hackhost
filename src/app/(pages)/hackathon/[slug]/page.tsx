      ...
      <Box>
        <Tabs variant={"unstyled"} defaultIndex={tabIndex}>
          ...
          <TabPanels minH={350}>
            <TabPanel>
              {hackathon?.subtitle && (
                <Card boxShadow={"base"} borderRadius={"md"} my={4}>
                  <CardBody>
              ...
              <Flex gap={{ lg: 6, base: 6 }} flexWrap={"wrap-reverse"}>
                <Skeleton
                  isLoaded={!isLoading}
                  flex={1}
                ...
                >
                  ...
                  >
                    <Box maxW={"full"}>
                      <MarkdownRenderer
                        markdown={hackathon?.description as string}
                      />
                    </Box>
                  </Box>
                </Skeleton>
            ...
            <TabPanel>
              {isEmpty(hackathon?.projects) ? (
                <Flex
                  ...
                  justify={"center"}
                >
                  <Heading color={"purple.800"} as={"h4"} size={"md"}>
                    No Projects yet for this hackathon.
                  </Heading>
                </Flex>
              ) : (
                <Flex gap={{ lg: 8, base: 6 }} flexWrap={"wrap-reverse"}>
                  <Skeleton
                    borderRadius={"base"}
                    isLoaded={!isLoading}
                    flex={1}
                  ...
                  >
                    <Box
                      ...
                      p={{ lg: "6", base: 4 }}
                    >
                      <ProjectCardList projects={hackathon?.projects} />
                    </Box>
                  </Skeleton>
                  <Skeleton isLoaded={!isLoading}>
                    <HackathonPageSidebar hackathon={hackathon} />
